...
static const std::vector<uint> PROPAGATOR_LAYOUT = { 64, 100, 80, 64 };
static const std::vector<uint> ANALYZER_LAYOUT = { 64, 100, 80, 30, 10, 1 };
static const std::vector<uint> FAST_LOOKUP_LAYOUT = { 64, 30, 10, 1 };
